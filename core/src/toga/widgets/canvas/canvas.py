...
class drawing_context_property:
    ...
    def __delete__(self, canvas, canvas_class=None):
        raise NotImplementedError(
            "Drawing context attributes can't be deleted. To reset to a default or "
...
class Canvas(Widget, DrawingActionDispatch):
    ...
    line_dash: list[float] = drawing_context_property(SetLineDash, [1.0])
